def ProblemDefinitionNonlinear( h, hOld, DiffX, timeConstant, timeStep, v, V, timeIntegrator, modelParameters, setBoundaryConditions, mesh, dx, ds ):
    
    # Returns the variational problem for solving Richards equation
    import firedrake as fd
    import numpy as np
    from modelTypes import relativePermeability, waterRetention
    ...
    + fd.inner( C*DiffX*fd.grad( h), fd.grad(v) ) )*dx
