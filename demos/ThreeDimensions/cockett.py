...
S     = Function(V, name='Saturation').interpolate((theta-soil_curves.parameters['theta_r'])/(soil_curves.parameters['theta_s']))
...
while time < t_final:
    ...
    if plot_iteration % 10 == 0:
        ...
        S.interpolate((theta-soil_curves.parameters['theta_r'])/(soil_curves.parameters['theta_s']))
        output.write(h, theta, S, time=time)
